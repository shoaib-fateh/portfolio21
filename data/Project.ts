export const projectDetails = [
  {
    ...
    image: "/projects/spacetravellers.png",
    technologies: ["Tailwind", "JavaScript", "React", "Api"],
    live: "https://space-travelers-0cew.onrender.com/",
    source: "https://github.com/tajulafreen/Space-Travelers-HUB",
  },
  {
    name: "Doctor Appointment",
    description: [
      "It is an online Doctor Reservation web application designed to provide users with the ability to reserve, view, and manage doctor and doctor appointment reservations. The system aims to streamline the process.",
    ...
    image: "/projects/doctorappointment.png",
    technologies: ["JavaScript", "React", "Ruby", "Rails", "Postgresql"],
    live: "https://doctor-appointment-eqlq.onrender.com/",
    source: "https://github.com/tajulafreen/Final-capstone-Frontend",
  },
  // Project #4
  {
    name: "Crytocurrency The Future",
    description: [
      "Crypto the Future is a website that provides users with the standing of Cryptocurrencies with their latest statistics accumulated during the 2019-2020 season.",
    ...
    live: "https://crypto-the-future.onrender.com/",
    source: "https://github.com/tajulafreen/CRYPTO-The-future/",
  },
  // Project #5
  {
    name: "MAMA Food",
    description: [
      "MAMA's food an online learning food, Bring the most delicious food to your home. Mama's food gives an incredible opportunity to learn various cooking techniques. Give you Access to an ever-growing library of classes by the world's best chefs.",
      "MAMA's food is an innovative online platform dedicated to providing an enriching culinary experience by delivering delicious and diverse cuisines directly to users' homes. Offering a unique fusion of learning and gastronomy, MAMA's Food presents an extensive array of cooking techniques, recipes, and culinary knowledge through its comprehensive online learning platform. By granting access to an expanding collection of classes curated by globally renowned chefs, it empowers users to master culinary skills, explore new recipes, and enhance their cooking prowess. With a focus on convenience and quality, MAMA Food endeavors to bring the finest and most delectable dishes to individuals' doorsteps while fostering a community of passionate food enthusiasts eager to embark on a journey of culinary discovery.",
    ],
    image: "/projects/mamafood.png",
    technologies: ["HTML", "CSS", "JavaScript"],
    live: "https://tajulafreen.github.io/first-capstone-project/",
    source: "https://github.com/tajulafreen/MAMA-Food",
  },
  // Project #6
  {
    name: "Leader Board",
    description: [
      ...
      "A leaderboard is a structured and often visualized representation showcasing the ranking, scores, or performance of individuals, entities, or participants within a specific competitive context. It provides a clear and organized layout presenting the relative standings of competitors, usually arranged in descending order based on their achievements, points, or accomplishments. Typically found in gaming, sports, business, or various online platforms, leaderboards offer users a quick and easily understandable overview of the top performers, fostering competition, motivation, and comparison among participants. This tool serves as a means of recognition, encouraging continued engagement and striving for higher positions within the displayed rankings.",
    ],
    image: "/projects/leaderboard.png",
    technologies: ["HTML", "CSS", "JavaScript", "React"],
    live: "https://github.com/tajulafreen/Leaderboard",
    source: "https://github.com/tajulafreen/Leaderboard",
  },
  {
    name: "To-DO List",
    description: [
      "React Todo App is an app that offers a seamless experience for managing todos effectively. Its user-friendly interface is combined with powerful features like adding, removing, editing todos, and changing the position of todos.",
      "The React Todo App is a user-centric application designed to streamline and organize tasks efficiently. Its intuitive interface provides users a seamless experience for managing their to-do lists. The app offers essential functionalities such as adding new tasks, removing existing ones, and editing task details as needed. Additionally, users can easily rearrange the position of their tasks, allowing for prioritization and customization according to their preferences. With a focus on user-friendliness and practicality, this app simplifies task management by combining powerful features with a clean and accessible design, enhancing user productivity and task organization.",
    ],
    image: "/projects/todolist.png",
    technologies: ["HTML", "CSS", "JavaScript", "React", "Tailwind"],
    live: "https://to-do-list-vxaq.onrender.com/",
    source: "https://github.com/tajulafreen/to-do-react",
  },
];
