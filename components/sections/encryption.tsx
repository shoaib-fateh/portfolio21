...
const EncryptionSection = () => {
  return (
    <div className="flex flex-row relative items-center justify-center min-h-screen w-full h-full mt-[-15%]">
      <div className="absolute w-auto h-auto top-0 z-[5]">
        <motion.div
          variants={slideInFromTop}
          className="md:text-[40px] text-4xl font-medium text-center text-gray-200"
        >
          Performance
      ...
      <div className="w-full flex items-start justify-center absolute">
        <video
          ...
          playsInline
          preload="false"
          className="w-full h-auto md:scale-100 scale-[2.5]"
